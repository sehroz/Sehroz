  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen  overflow-hidden">
      ...
      <div className=" w-4/12 z-10 relative">
        <h2 className="text-xl font-bold text-zinc-100">Hey, I am </h2>{" "}
      </div>
      ...
      <div className="  animate-fade-in grid text-center p-10 ">
        <h1 className=" text-sm  font-light text-white pt-5">My Recent Work</h1>
        <div className="flex w-screen sm:w-fit align-middle justify-evenly   items-center pt-2 text-xl font-thin">
          <Link
            ...
            className=" hover:font-bold  underline duration-500 text-white px-10"
          >
            Alpha <br /> Appraisals
          </Link>{" "}
          <Link
        ...
        >
          <svg viewBox="0 0 24 24" fill="white" height="1.5em" width="auto">
          ...
          <span className="font-light"> Toronto, Ontario </span>
        </a>
      </div>
    </div>
  );
